...
describe('认证与设置', () => {
  ...
  test('验证字段并以版本号阻止设置覆盖', async () => {
    ...
    const setting = { revision: 0, title: '工作台', appearance: 'dark', themeId: 'default', wallpaperType: 'none', wallpaperValue: '', wallpaperAutoRotate: false, wallpaperRotateInterval: 60, activeWallpaperPoolId: null, wallpaperFitMode: 'cover', customCss: 'body { font-size: 14px; }', allowDragWithoutEdit: true, iframeAllowlist: [] }
